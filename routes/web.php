...
Route::post('/training_and_placement_cell/companyStudent/written', ['as' => 'companyStudent_store', 'uses' => 'Training_and_Placement_Cell\CompanyStudentController@store']);

Route::post('/training_and_placement_cell/companyStudent', ['as' => 'companyStudent_storeInter', 'uses' => 'Training_and_Placement_Cell\CompanyStudentController@storeInter']);
...
Route::get('/training_and_placement_cell/tpo/selectedOptions', 'Training_and_Placement_Cell\SelectedStudentController@showOptionsTpo');

Route::get('/training_and_placement_cell/tpo/placed', 'Training_and_Placement_Cell\SelectedStudentController@showTpoP');

Route::get('/training_and_placement_cell/tpo/selectedWritten', 'Training_and_Placement_Cell\SelectedStudentController@showTpo');

Route::get('/training_and_placement_cell/student/selectedOptions', 'Training_and_Placement_Cell\SelectedStudentController@showOptions');

Route::get('/training_and_placement_cell/student/placed', 'Training_and_Placement_Cell\SelectedStudentController@showP');

Route::get('/training_and_placement_cell/student/selectedWritten', 'Training_and_Placement_Cell\SelectedStudentController@show');
