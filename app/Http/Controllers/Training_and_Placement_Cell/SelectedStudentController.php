...
class SelectedStudentController extends Controller
{
	public function showOptions() {
		return view('training_and_placement_cell.selectedOptions');
	}

	public function showOptionsTpo() {
		return view('training_and_placement_cell.selectedOptionsTpo');
	}
    ...
    public function show() {
		...
		$student = DB::table('Applied_For_Company')
						...
						->where('Applied_For_Company.test_result', '=', '1')
	    ...
	    return view('training_and_placement_cell.list.selectedWritten', compact(['company', 'student', 'students']));
	}
	...
	public function showTpo() {
		...
		// echo ($student);
	    return view('training_and_placement_cell.list.selectedWrittenTpo', compact(['company', 'student', 'students']));
	}

	public function showTpoP() {
		if(Auth::user()->user_type != 'others'){
            return Redirect::to('training_and_placement_cell');
        }
		$company = Company::with('compStud')->orderBy('name', 'asc')->get();
