        ...
        <div class="main-container row">
            ...
            <div>
             <div class="container col s10" style= "position:relative;box-shadow:0 2px 5px 0 rgba(0,0,0,0.16),0 2px 10px 0 rgba(0,0,0,0.12);margin-left:75px;margin-top:20px;padding-top:20px;">
              ...
              <!-- <div class="container col s10" style= "position:relative; margin-left:75px;"> -->
              <!-- <ul class="collapsible popout" data-collapsible="accordion">
              <li style="margin: 0 -10px;">
                <div class="collapsible-header">Rounds*</div>
                    <div class="collapsible-body container">
                        ...
                        <div style="display: none;">
                          ...
                          <div class="row rounds" style="display: none;">
                            <div class="input-field col m10">
                              {!! Form::text('', null, 
                                    array('id' => 'round', 
                                          'class'=>'validate', 'placeholder'=>'Name of Round')) !!}
                            ...
                            <a class="waves-effect btn" id="removeRound">Remove</a> 
                          </div>
                          
                         
                        </div>
                        <a class="waves-effect btn add_btn" id="addRound">Add</a>
                    </div>
                    </li>
                  </ul> -->
