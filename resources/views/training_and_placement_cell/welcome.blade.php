        ...
        <nav class="mynav">
          <div class="nav-wrapper">
            ...
            <ul style="float:right;">
                <li><a class="modal-trigger" href="#notify"><span id="blinker">{{$count}} new company arrivals!</span></a></li>
        ...
        <div id="notify" class="modal">
            <div class="modal-content">
                ...
                <table class="bordered highlight">
                    ...
                    <tbody>
                    @foreach($countDates as $countDates) 
                        <tr> 
                            <td>{{$countDates->name}}</td> 
                            <td>{{$countDates->arrival_date}}</td> 
                        </tr> 
                    @endforeach  
                    </tbody>
                </table>
